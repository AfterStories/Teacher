...
/*            "fnDrawCallback": function( oSettings ) {  
            ...
            },
            {
                ...
                "render": function(data, type, row,full) {
                    var s = '<span title="上传录播课视频" class="handle-btn handle-btn-edit" style="margin-right:14px;"><i class="layui-icon" onclick="uploadVideo('+data+')">&#xe62f;</i></span>';
                    return s;
                },
                "className": "td-handle"
            },             
            {
                ...
                "render": function(data, type, row,full) {
                    var s = '<span title="上传课程录像" class="handle-btn handle-btn-edit" style="margin-right:14px;"><i class="layui-icon" onclick="uploadRecording('+data+')">&#xe62f;</i></span>';
                    return s;
                },
                "className": "td-handle"
            },
            {
                ...
                "render": function(data, type, row,full) {
                    var s = '<span title="上传作业题" class="handle-btn handle-btn-edit" style="margin-right:14px;"><i class="layui-icon" onclick="uploadhomework('+data+')">&#xe62f;</i></span>';
                    return s;
                },
                "className": "td-handle"
            },              
